...
const AdminRoutes = [
  ...
  { path: "/master/lead-customer", element: <LeadCustomerList/>, meta: { layout: "full", publicRoute: false } },
  { path: "/master/lead-customer/:id?/:type", element: <LeadCustomerForm />, meta: { layout: "full", publicRoute: false } },
