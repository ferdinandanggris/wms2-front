...
export default function master(state = initialState, action) {
  ...
  switch (type) {
    ...
    case LOAD_CUSTOMERDETAIL:
      return { ...state, customerDetail: payload.data };
