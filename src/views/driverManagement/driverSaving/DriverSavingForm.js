...
const DriverSavingForm = ({ user, data, loadData, addData, editData, master, loadDriver, loadLoanType, setAlert }) => {
  ...
  const onSelectChange = (e, name) => {
    if (name === "driverID") {
      ...
      if (driver === undefined && driver === null) {
        ...
        setFormData({
          ...formData,
          accountNumber: driver.accountNo,
          accountBank: driver.mobileNo1,
