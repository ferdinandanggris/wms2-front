...
const StartedList = ({ user, data, refreshData, deleteData, exportData, setShipmentStatus }) => {
  const title = "Started Shipment";
  ...
  const exportFilename = "started.csv";
  const condition = { status: "STARTED" };
...
export default connect(mapStateToProps, { refreshData, deleteData, exportData, setShipmentStatus })(StartedList);
