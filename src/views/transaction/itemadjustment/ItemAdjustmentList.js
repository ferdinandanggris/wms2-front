...
const ItemAdjustmentList = ({ user, data, refreshData, deleteData, exportData, master, loadVendor }) => {
    ...
    const columns = [
        ...
        { label: "REFERENCE #", key: "referenceNo", width: 40, align: "right", cardSubTitle: true },
        { label: "VENDOR", key: "vendorId", width: 40, align: "right", cardSubTitle: true },
        { label: "CREATED BY", key: "createdBy", width: 40, align: "right", cardSubTitle: true },
        { label: "CREATED DATE", key: "createddate", width: 40, align: "right", cardSubTitle: true },
        { label: "POSTED BY", key: "postedBy", width: 40, align: "right", cardSubTitle: true },
        { label: "POSTED DATE", key: "postDate", width: 40, align: "right", cardSubTitle: true },
        { label: "LINE", key: "line", width: 40, align: "right", cardSubTitle: true },
