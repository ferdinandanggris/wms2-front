...
const ReceivingForm = ({ user, data, loadData, addData, editData }) => {
    let { id } = useParams();
        ...
        return (
          ...
          <div className="row align-items-center mb-3">
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <label className="col-sm-1 text-left col-form-label">Vendor</label>
                        <div className="col">
                    ...
                    <div className="row align-items-center mb-3">
  <label className="col-sm-2 col-form-label">Category <span className="text-danger">*</span></label>
  <div className="col-sm-3">
    <select className="form-control" name="customerType" value={customerType} onChange={(e) => onChange(e)}>
      <option value="">** Please select</option>
      <option value="1">Type 1</option>
...
export default connect(mapStateToProps, { loadData, addData, editData })(ReceivingForm);